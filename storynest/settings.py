"""
Django settings for StoryNest project.
...
MIDDLEWARE = [
    ...
    'storynest.middleware.AdminStaticFilesMiddleware',
]
...
WSGI_APPLICATION = 'storynest.wsgi.application'
